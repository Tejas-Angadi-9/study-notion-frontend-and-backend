...
const Sidebar = () => {
  ...
  return (
    <div>
      <div className="flex min-w-[222px] gap-2 flex-col border-r-[1px] border-r-richblack-700 h-[calc(100vh-3.5rem)] bg-richblack-800 py-10">
        <SidebarLinks
          link={{
        ...
        <button
          onClick={() =>
            setConfirmationModal({
              ...
              btn1Handler: () => setConfirmationModal(null), // this makes the modal to close
            })
          }
