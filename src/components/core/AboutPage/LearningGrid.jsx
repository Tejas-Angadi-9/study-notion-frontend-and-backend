...
const LearningGridData = [
    ...
    },
    {
        order: 4,
        heading: "Rating\nAuto-grading",
        description: "Save time and moYou will immediately get feedback during the learning process without having to wait for an answer or response from the mentor.ney! The Belajar curriculum is made to be easier to understand and in line with industry needs."
    },
    {
        order: 5,
